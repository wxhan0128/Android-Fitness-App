...
public class CircleBar extends View {
	...
	private int maxIndex = 100;// 默认最大步数
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawText(
				...
				mColorWheelRectangle.centerX()
						- (mTextch.measureText(String.valueOf("体质指数")) / 2),
				Text_y, mTextch);
	}
	...
	public void setAnimationTime(int time) {
		anim.setDuration(time * index / maxIndex);// 按照比例设置动画执行时间
	}
}